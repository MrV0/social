...
<div class="main_column column">
    ...
    if($imgSrc){ //if an image has been uploaded display cropping area?>
        ...
        <div id="CroppingContainer" style="width:800px; background-color:#FFF; margin-left: -200px; position:relative; overflow:hidden; border:2px #666 solid; z-index:2001; padding-bottom:0px;">

            <div id="CroppingArea" style="width:500px; position:relative; overflow:hidden; margin:40px 0px 40px 40px; border:2px #666 solid; float:left;">
